class HorizontalLinesGame {
    constructor() {
        ...
        this.textSettings = {
            ...
            instructionText: urlParams.has('instructionText') ? urlParams.get('instructionText') : 'Move left or right',
    ...
    showClaimedCode(discountCode, percentage = null) {
        ...
        if (discountModal && discountCodeText) {
            ...
            // Optional: update the title percentage on the hidden results UI for consistency.
