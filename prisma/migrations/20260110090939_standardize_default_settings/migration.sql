...
CREATE TABLE "new_GameSettings" (
    ...
    "popupDelay" TEXT NOT NULL DEFAULT '3',
    ...
    "showStickyButton" BOOLEAN NOT NULL DEFAULT true,
    ...
    "stickyButtonPosition" TEXT NOT NULL DEFAULT 'bottom',
    ...
    "stickyButtonShowOnMobile" BOOLEAN NOT NULL DEFAULT false,
    "logoUrl" TEXT,
    "logoUrlMobile" TEXT,
